...
MCS data format support has been moved to [brighteyes-mcs-reader](https://github.com/VicidominiLab/BrightEyes-MCS-Reader). Legacy MCS reading is available from `brighteyes_mcs_reader.reader_legacy`.
